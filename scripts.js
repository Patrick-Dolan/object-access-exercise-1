...
const musicGenres = {
  "rock": {
    "artists": {
      1: {
        "name": "The Beatles",
        "album-names": ["Revolver", "Abbey Road", "Sgt. Pepper's Lonely Hearts Club Band"]
      },
      2: {
        "name": "Led Zeppelin",
        "album-names": ["IV", "Physical Graffiti", "Led Zeppelin II"]
      },
      3: {
        "name": "Queen",
        "album-names": ["A Night at the Opera", "The Game", "News of the World"]
      }
    }
  },
  "jazz": {
    "artists": {
      1: {
        "name": "Miles Davis",
        "album-names": ["Kind of Blue", "Bitches Brew", "In a Silent Way"]
      },
      2: {
        "name": "John Coltrane",
        "album-names": ["A Love Supreme", "Giant Steps", "Blue Train"]
      },
      3: {
        "name": "Ella Fitzgerald",
        "album-names": ["Ella Fitzgerald Sings the Cole Porter Song Book", "Ella and Louis", "Ella Fitzgerald Sings the Duke Ellington Song Book"]
      }
    }
  },
  "pop": {
    "artists": {
      1: {
        ...
        "album-names": ["Thriller", "Bad", "Off the Wall"]
      },
      2: {
        "name": "Madonna",
        "album-names": ["Like a Prayer", "Ray of Light", "True Blue"]
      },
      3: {
        "name": "Justin Timberlake",
        "album-names": ["FutureSex/LoveSounds", "The 20/20 Experience", "Justified"]
      }
    }
  }
}

// Console log the following answers to the questions:
// ===================================================
